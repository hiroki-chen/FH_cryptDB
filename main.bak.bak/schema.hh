...
// TODO We want to create a smooth list for all of the fields.
typedef class SaltNode {
public:
	// TODO how to implement them.
	SaltNode();
	std::string serializeHelper() const;
...
public:
    ...
    bool needEnc() const {return need_enc;}
...
private:
    ...
    bool need_enc; // Whether this field should be encrypted
