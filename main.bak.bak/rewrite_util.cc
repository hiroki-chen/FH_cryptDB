...
gatherAndAddAnalysisRewritePlan(const Item &i, Analysis &a)
{
    ...
    std::cout << "calling gather for item" << i << std::endl; //Values can be deducted from item type?...
                      ...
                      List<Create_field> &rewritten_cfield_list)
{
    ...
    std::cout <<"I'am in CreateandRewrite now! Attention!"<<std::endl;
