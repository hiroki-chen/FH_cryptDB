...
void Connect::do_connect(const std::string &server, const std::string &user,
                         const std::string &passwd, uint port)
{
...
bool Connect::execute(const std::string &query, std::unique_ptr<DBResult> *res,
...
bool Connect::execute(const std::string &query, bool multiple_resultsets)
{
...
//static Item * getItem(char *const content, enum_field_types type, uint len)
//{
//    if (content == NULL) {
//        return new Item_null();
//    }
