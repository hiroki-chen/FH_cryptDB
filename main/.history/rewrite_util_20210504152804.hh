...
bool
loadLocalTable(const std::string &path, rapidjson::Document &doc);
...
bool
getDocumentFromFileAndLoadSalt(const std::string &path, Analysis &a, rapidjson::Document &doc, bool load = true);
