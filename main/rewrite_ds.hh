...
// If it does not suppot FH, then for the constant, it will fail to give an intersection.
const EncSet EQ_EncSet = {
    {
        {oPLAIN, LevelFieldPair(SECLEVEL::PLAINVAL, NULL)},
        //{oFHDET, LevelFieldPair(SECLEVEL::FHDET, NULL)},
        //{oFHOPE, LevelFieldPair(SECLEVEL::FHOPE, NULL)},
        {oDET, LevelFieldPair(SECLEVEL::DET, NULL)},
        {oOPE, LevelFieldPair(SECLEVEL::OPE, NULL)},
    }};

const EncSet FH_EQ_EncSet = {
    {
        {oPLAIN, LevelFieldPair(SECLEVEL::PLAINVAL, NULL)},
        {oFHDET, LevelFieldPair(SECLEVEL::FHDET, NULL)},
    }};
