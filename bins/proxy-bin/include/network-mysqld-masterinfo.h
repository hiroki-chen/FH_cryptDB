 ...
 * @master_lines: number of lines in the masterinfo
 * @master_log_file: logfile name
 * @master_log_pos: position in logfile
 * @master_host: master host
 * @master_user: master user
 * @master_password: password
 * @master_port: port
 * @master_connect_retry: connect retry count
 * @master_ssl: SSL enabled?
 * @master_ssl_ca: CA 
 * @master_ssl_capath: CA path
 * @master_ssl_cert: cert
 * @master_ssl_cipher: cipher
 * @master_ssl_key: key
 * @master_ssl_verify_server_cert: verify server cert?
 *
 * master.info file
 */
typedef struct {
