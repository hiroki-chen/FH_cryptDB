...
CHASSIS_API GString *g_string_dup(GString *src);
...
CHASSIS_API void ge_gtimeval_diff(GTimeVal *told, GTimeVal *tnew, gint64 *tdiff);
CHASSIS_API GString *g_string_assign_len(GString *s, const char *str, gsize str_len);
CHASSIS_API void g_debug_hexdump(const char *msg, const void *_s, size_t len);
