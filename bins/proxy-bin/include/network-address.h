 ...
 * network_socklen_t:
 *
 * define network_socklen_t in a portable way
 *
 ...
 *
 * error domain of all network-address errors
 *
 * See: network_address_error()
 */
...
/**
 * network_address:
 * @name: resolved name of the address
 * @len: length of @addr
 *
...
NETWORK_API void network_address_free(network_address *addr);
