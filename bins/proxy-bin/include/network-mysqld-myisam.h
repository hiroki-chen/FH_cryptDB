...
/**
 * network_mysqld_myisam_field_data_t:
 * @i: a uint64
 * @s: a string
 * @f: a double
 *
 * storage for a #network_mysqld_myisam_field
 */
typedef union {
	guint64 i;
	gchar *s;
...
typedef struct {
	...
	network_mysqld_myisam_field_data_t data;
	guint64 data_len;
 ...
 * @fields: (element-type network_mysqld_myisam_field): fields of a row
 *
